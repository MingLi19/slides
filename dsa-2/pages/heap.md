...
在实际应用中，我们可以直接使用编程语言提供的堆类。以 Python 为例，`heapq` 模块提供了堆的实现。
...
“树 Tree”章节讲过，完全二叉树非常适合用数组来表示。由于堆正是一种完全二叉树，因此我们将采用数组来存储堆。
...
<img class="w-100 mx-auto" src="../images/heap/array_heap.png" />
...
<v-switch>
  <template #1>
    <img class="w-140 mx-auto" src="../images/heap/in1.png" />
  </template>
  <template #2>
    <img class="w-140 mx-auto" src="../images/heap/in2.png" />
  </template>
  <template #3>
    <img class="w-140 mx-auto" src="../images/heap/in3.png" />
  </template>
  <template #4>
    <img class="w-140 mx-auto" src="../images/heap/in4.png" />
  </template>
  <template #5>
    <img class="w-140 mx-auto" src="../images/heap/in5.png" />
  </template>
  <template #6>
    <img class="w-140 mx-auto" src="../images/heap/in6.png" />
  </template>
  <template #7>
    <img class="w-140 mx-auto" src="../images/heap/in7.png" />
  </template>
  <template #8>
    <img class="w-140 mx-auto" src="../images/heap/in8.png" />
  </template>
  <template #9>
    <img class="w-140 mx-auto" src="../images/heap/in9.png" />
  </template>
</v-switch>
...
<img class="w-110 mx-auto" src="../images/heap/topk1.png" />
...
<img class="w-110 mx-auto" src="../images/heap/topk2.png" />
